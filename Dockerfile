...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Chrisdroid1/firebot/master/firebotmain.py
RUN wget https://raw.githubusercontent.com/Chrisdroid1/firebot/master/requirements.txt
#Start Fumkin
